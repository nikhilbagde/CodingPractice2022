...
public class B extends A{
    ...
    public static void main(String[] args) {
        ...
        This Class Name class GeeksForGeeks.JavaReview.ConstructorChaining.B Super Class Name: class GeeksForGeeks.JavaReview.ConstructorChaining.B -> same class name of this and super -> B
         */
