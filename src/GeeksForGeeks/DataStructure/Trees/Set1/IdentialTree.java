...
public class IdentialTree {
    ...
    public static void main(String[] args) {
        GeeksForGeeks.DataStructure.Trees.BinaryTree tree1 = ConstructBST.constructBinarySearchTree();
        GeeksForGeeks.DataStructure.Trees.BinaryTree tree2 = ConstructBST.constructBinarySearchTree();
